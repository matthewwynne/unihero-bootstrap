    ...
    <b-container class="footer pt-3 pb-4">
      ...
      <b-row>
        ...
        <b-col xs="12" lg="2" md="3">
          ...
          <router-link class="link-social fab-instagram mr-2" to=""></router-link>
          <router-link class="link-social fab-facebook mr-2" to=""></router-link>
          <router-link class="link-social fab-linkedin" to=""></router-link>
        </b-col>
      </b-row>
    </b-container>
    </footer>
